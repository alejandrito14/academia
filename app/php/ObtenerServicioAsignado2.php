...
try
{
	...
	$obtenerasigacion=$lo->BuscarAsignacionAlumno();
	if ($idtipousuario==3) {
	...
	if ($idtipousuario==5) {
		...
		$evaluaciones=$encuesta->ObtencuestaActivosServicio();

	}

	$idusuarios_servicios=$obtenerasigacion[0]->idusuarios_servicios;
	$respuesta['idusuarios_servicios']=$idusuarios_servicios;
