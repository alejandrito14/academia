...
try
{
	...
	$lo->db = $db;
	$iduser=$_POST['idusuertutorado'];
	$asignados->idusuario=$iduser;
	$obtenerservicios=$asignados->obtenerServiciosAsignadosAgrupados();

	$serviciosasignados=$obtenerservicios[0]->serviciosasignados;
	
	$obtenerserviciosActivos=$lo->ObtenerServiciosActivos($serviciosasignados);
