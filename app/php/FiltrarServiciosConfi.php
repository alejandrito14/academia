...
try
{
	...
	$page = isset($_POST['pagina']) ? (int)$_POST['pagina'] : 1;
	$limit = 10;
	$offset = ($page - 1) * $limit;
	...
	if (isset($_POST['tipoconfiguracion'])) {
		$tipoconfiguracion=$_POST['tipoconfiguracion'];
	}
	...
	$obtenerservicios=$lo->ObtenerServiciosAdmin5($tipoconfiguracion,$tipocategoria,$v_coach,$v_mes,$v_anio,$limit,$offset);
