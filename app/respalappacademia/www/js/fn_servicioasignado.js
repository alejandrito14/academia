              ...
              <div class="item-inner" style="width:80%;">
                ...
                <div class="item-media">
                        ...
                        <img src="`+urlimagen+`" alt="" style="width:60px;height:60px;" />
                        	...
                        	<div class="col-100">
                        	 <div class="col-100 item-text" style="margin-left: 1em;font-size:18px;word-break:break-all;" id="participante_`+respuesta[i].idusuarios+`">`+respuesta[i].nombre+` `+respuesta[i].paterno+`
             		   </div>


                     <div class="row">
             		     <div class="col-100 item-text" style="font-size:18px; word-break:break-all;" id="correo_`+respuesta[i].idusuarios+`">`+respuesta[i].usuario+`
             		     </div>
             		   </div>
