...
$cli->lista_empresas = $lista_empresas;
	 ...
	 $sql_cliente = $cli->lista_UsuariosTutores();
					  	  ...
					  	  <!--	<td style="text-align:center;"><?php echo utf8_encode($result_sucursal_row['sucursal']); ?></td>-->
						  	<td align="center">
										...
										<?php
													...
													$bt->funcion = "BorrarCliente('".$result_row['idusuarios']."','".$nombre."',".$idmenumodulo.",'catalogos/tutores/vi_tutores.php')";
													$bt->estilos = "";
													$bt->permiso = $permisos;
													$bt->tipo = 3;
													$bt->title="BORRAR";
...
<!--								<button type="button" onClick="AbrirModalGeneral2('ModalPrincipal','900','560','catalogos/fc_cliente.php?id=<?php echo $result_row['idcliente'];?>');" title="EDITAR" class="btn btn-outline-info"><i class="mdi mdi-table-edit"></i></button>
								...
								<button type="button" onClick="BorrarDatos('<?php echo $result_row['idcliente'];?>','idcliente','Usuarios','n','catalogos/vi_Usuarios.php','main')" title="BORRAR" class="btn btn-outline-danger"><i class="mdi mdi-delete-empty"></i></button>-->
				...
				<td colspan="6" style="text-align: center">
					<h5 class="alert_warning">NO EXISTEN TUTORES EN LA BASE DE DATOS.</h5>
				</td>
			</tr>
