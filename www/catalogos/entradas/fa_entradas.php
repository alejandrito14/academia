	...
	<div class="card">
		<div class="card-body">
			...
			AbrirNotificacion('Han ocurrido los siguientes errores:<br> Tipo Es requerido','mdi-checkbox-marked-circle');
				...
				<button type="button" onClick="aparecermodulos('catalogos/entradas/vi_entradas.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i>VER LISTADO </button>
