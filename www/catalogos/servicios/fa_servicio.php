...
$bloqueocanchas=$result_SERVICIO_row['bloqueocanchas'];
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
	...
	<div class="card-body">
							...
							<div class="form-group m-t-20">
					 	<label for="" id="lbltiposervicio">*SUBCATEGORÍA:</label><br>
  ...
  <div class=" btn-group-toggle licategoriasservicio" data-toggle="buttons">
						...
						<div class="form-group m-t-20 divcategoria" style="display: none;">
							<label for="" id="lblcategoria">* SUB SUB CATEGORÍA:</label>
				
<div class=" btn-group-toggle lisubsubcategorias " data-toggle="buttons">
									<!-- <?php
 ...
 -->
	    ...
	    display: flex;padding: 10px;">
		    <input type="checkbox" id="habilitarbloqueocanchas" class="form-check-input checkcambia" value="1" style="top: -0.3em;" onchange="HabilitarBloqueoCanchas()" >
		    <label for="" class="form-check-label" style="margin-left: 10px;">Bloqueo de espacios</label>
    ...
    display: flex;">
								...
								<div class="row"  style="margin-bottom: 1em;margin-top: 1em;">
													...
													<div class="col-md-3" style="float:left;">
														<button type="button" style="    width: 100%;" onclick="Aplicar()" class="btn btn-primary btnaplicar">APLICAR</button>
						...
						<div class="row">
							 <div class="" style="    margin-top: 40px;margin-left: 10px;">
								   	<h3 id="titulototalhorarios" style="font-size: 28px !important;">Total de horarios: <span id="totalhorarios">0</span></h3>
								   </div>
						</div>
...
<div class="modal fade" id="modalaplicar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					        ...
					        <div class="row" style="">
					        	<div class=" col-md-12 seleccionfiltro">
					        		 	<div class="">
										     ...
										     <div class="row" >
										    	<div class="habilitarfiltros" style="display: none;    width: 100%;">
    ...
    margin-left: 0;">
										        		<div style="" class="col-md-12">
										        			 <button type="button" class="btn btn-secondary" style="   width:100%;" onclick="AceptarHorarioCancha()" >Aceptar</button>
										        			</div>
										    ...
										    <div class="row" >
										    	<div class="seleccionautomatica col-md-12" style="display: none;">
										    		...
										    		<div class="col-md-12">
										        <h3 style="text-align: center;">Del filtro que seleccionaste ¿Deseas que se marque automáticamente?</h3>
...
<div class="modal fade" id="modalaplicar2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel"></h5>
					      ...
					      <div class="modal-body">
					        <div class="row" style="">
					        	<div class=" col-md-12 seleccionfiltroh">
					        		 	<div class="">
										        <h3 style="text-align: center;">¿Deseas filtrar los horarios?</h3>
										        ...
										        <div class="col-md-12">
										        	<div class="row" style="justify-content: center;">
										        		<div style="">
										        			 <button type="button" class="btn btn-secondary" onclick="HabilitarFilltrosH()">Si</button>

										        			  <button type="button" class="btn btn-secondary"  onclick="PasarAseleccionH()">No</button>
										     ...
										     <div class="row" >
										    	<div class="habilitarfiltrosh" style="display: none;width: 100%;">
    ...
    margin-top: 1em;">
										        		<h4>Elige un horario</h4>
										        		<select id="v_horarios2" class="form-control " multiple="multiple" tabindex="-1">
																					<option value="0">Seleccionar horario</option>
																				</select>
										        	</div>
    ...
    margin-left: 0;">
										        		<div style="" class="col-md-12">
										        			 <button type="button" class="btn btn-secondary" style="width:100%;" onclick="AceptarSoloHorario()" >Aceptar</button>
										        			</div>
										    ...
										    <div class="row" >
										    	<div class="seleccionautomaticah col-md-12" style="display: none;">
										        ...
										        <h3 style="text-align: center;">Del filtro que seleccionaste ¿Deseas que se marque automáticamente?</h3>
										        	...
										        	<div class="row" style="justify-content: center;">
										        		<div style="">
										        			 <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="SeleccionAutomaticaH(1)">Si</button>

										        			  <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="SeleccionAutomaticaH(0)">No</button>
			...
			<div class="card">
				...
				<div class="card-body">
						<div class="form-group m-t-20">
								...
								<div class="form-group m-t-20 col-md-4" id="cantidadligar" style="display: none;">
									<label for="">CANTIDAD</label>
...
*/
			...
			if (idtiposervicioconfiguracion>0) {
				ElegirTipoConfiguracion(idtiposervicioconfiguracion,idcategoriaservicio);
			}
...
idcategoriaservicioelegida=idcategoria;
		...
		$("#v_politicasaceptacionid").val(idpoliticaaceptacion);
		 ...
		 SeleccionarCategoria(idcategoriaservicio);

		 SeleccionarCategoriaServicio(idcategoria);
		...
		if (bloqueocanchas==1) {
			...
			ObtenerHorariosBloqueoCancha(idservicio);
		}
