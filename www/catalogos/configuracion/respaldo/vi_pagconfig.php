		...
		<div class="card">
			...
			<div class="card-body">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#textos" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">TEXTOS EN LA APP</span></a> </li>
