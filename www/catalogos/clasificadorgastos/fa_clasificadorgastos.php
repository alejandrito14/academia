...
$db = new MySQL();
$emp = new CategoriasClasificador();
$f = new Funciones();
...
if(!isset($_GET['idclasificadorgasto'])){
	...
	$col = "col-md-12";
	$ver = "display:none;";
	$titulo='NUEVA CATEGORIA DE GASTO';
	...
	$idcategoria = $_GET['idclasificadorgasto'];
	$emp->idclasificadorgasto = $idcategoria;

	//Realizamos la consulta en tabla empresas
	$result_presentacion = $emp->buscar_categoriaclasificador();
	...
	if($foto==""){
		...
		$ruta="catalogos/categoriapaquete/imagenescategoria/".$_SESSION['codservicio']."/$foto";
	}

	$col = "col-md-12";
	$ver = "";
		$titulo='EDITAR CATEGORIA DE GASTOS';
		...
		<div class="card-body">
			...
			<div style="float: right;">
				...
				<?php
					...
					$bt->funcion = "var resp=MM_validateForm('v_nombre','','R'); if(resp==1){ GuardarCategoriasclasificador('f_categoria','catalogos/clasificadorgastos/vi_clasificadorgastos.php','main','$idmenumodulo');}";
				...
				<button type="button" onClick="aparecermodulos('catalogos/clasificadorgastos/vi_clasificadorgastos.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i> LISTADO DE CATEGORÍAS DE GASTOS </button>
								    ...
								    <div class="card" style="width: 18rem;margin: auto;margin-top: 3em;">
								        ...
								        <div class="card-body">
								            ...
								            <div class="form-group">
								                ...
								                <input type="file" class="form-control-file" name="image" id="image" onchange="SubirImagenCategoriapaquete()">
								            </div>
...
<p style="text-align: center;">Dimensiones de la imagen Ancho:1280px Alto:852px</p>
							...
							<div class="form-group m-t-20" style="">
								...
								<?php 
									...
									$categorias= $cuentas->ObtenerTodosCuentas();
								...
								<!-- <select  class="form-control" id="v_depende" name="v_depende" >
									...
									?>
										...
										<div class="btn btn_colorgray2 btncategoria " id="categoria_<?php echo $categorias_row['idcuenta']?>">
											
											<input type="checkbox" id="categoriacheck_<?php echo $categorias_row['idcuenta']?>" class="catecheck" onchange="SeleccionarCategoriaClasificador('<?php echo  $categorias_row['idcuenta']?>')" value="0">

											<?php echo $categorias_row['nombre'];?>
...
<script>
	...
	var idclasificadorgasto='<?php echo $idcategoria; ?>';

			 if (idclasificadorgasto>0) {
			 	
			 	SeleccionarCategoriaClasificador(depende);
			 }

	   $("#v_empresa").chosen({width:"100%"});

	    function SubirImagenCategoriapaquete() {
	 	// body...
        ...
        $.ajax({
            url: 'catalogos/categoriapaquete/upload.php',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
