		...
		<div class="table-responsive" id="contenedor_categoriasservicio">
			<table id="tbl_categoriasservicio" cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
				...
				<tbody>
					...
					if($l_categoriasservicio_num== 0){
						...
						do
						{
							...
							<td style="text-align: center; font-size: 15px;">
									...
									$bt->funcion = "aparecermodulos('catalogos/categoriasservicios/fa_categoriaservicios.php?idmenumodulo=$idmenumodulo&idcategoriasservicio=".$l_categoriasservicio_row['idcategoriasservicio']."','main')";
									$bt->estilos = "";
									$bt->permiso = $permisos;
									$bt->tipo = 2;
									$bt->title="EDITAR";
                  ...
                  $bt->funcion = "BorrarDatos('".$l_categoriasservicio_row['idcategoriasservicio']."','idcategoriasservicio','categoriasservicio','n','catalogos/categoriasservicios/vi_categoriasservicios.php','main','$idmenumodulo')";
                  $bt->estilos = "";
                  $bt->permiso = $permisos;
                  $bt->tipo = 3;
                  $bt->title="BORRAR";
