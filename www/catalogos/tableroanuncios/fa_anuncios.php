	...
	<div class="card">
		<div class="card-body">
			...
			<div style="float: right;">
				...
				<button type="button" onClick="aparecermodulos('catalogos/tableroanuncios/vi_anuncios.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i> LISTADO DE TABLERO DE ANUNCIOS </button>
