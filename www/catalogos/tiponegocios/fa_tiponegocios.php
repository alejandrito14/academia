...
if(!isset($_GET['idtiponegocio'])){
	...
	$obtenerorden=$emp->ObtenerUltimoOrdentiponegocio();
	...
	$idtiponegocio = $_GET['idtiponegocio'];
	$emp->idtiponegocio = $idtiponegocio;

	//Realizamos la consulta en tabla empresas
	$result_presentacion = $emp->buscartiponegocio();
	...
	if($foto==""){
		...
		$ruta="catalogos/tiponegocios/imagenes/".$_SESSION['codservicio']."/$foto";
	}
...
<form id="f_tiponegocio" name="f_tiponegocio" method="post" action="">
	<div class="card">
		<div class="card-body">
			...
			<div style="float: right;position:fixed!important;z-index:10;right:0;margin-right:2em;width: 20%;">
				...
				<?php
					...
					$bt->funcion = "var resp=MM_validateForm('v_nombre','','R'); if(resp==1){ Guardartiponegocios('f_tiponegocio','catalogos/tiponegocios/vi_tiponegocios.php','main','$idmenumodulo');}";
				...
				<button type="button" onClick="aparecermodulos('catalogos/tiponegocios/vi_tiponegocios.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i> VER LISTADO </button>
				<div style="clear: both;"></div>
				
				<input type="hidden" id="id" name="id" value="<?php echo $idtiponegocio; ?>" />
			</div>
			<div style="clear: both;"></div>
		</div>
	</div>
								    ...
								    <div class="card" style="width: 18rem;margin: auto;margin-top: 3em;">
								        ...
								        <div class="card-body">
								            ...
								            <div class="form-group">
								                ...
								                <input type="file" class="form-control-file" name="image" id="image" onchange="SubirImagentiponegocio()">
								            </div>
...
<script>
	...
	var idtiponegocio='<?php echo $idtiponegocio; ?>';
	...
	if (idtiponegocio>0) {
	   ...
	   $("#v_empresa").chosen({width:"100%"});
	    ...
	    function SubirImagentiponegocio() {
	 	// body...
        ...
        $.ajax({
            url: 'catalogos/tiponegocios/upload.php',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
