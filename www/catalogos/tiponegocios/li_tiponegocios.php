	...
	<tbody>
			...
			<tr> 
				<td colspan="7" style="text-align: center">
					<h5 class="alert_warning">NO EXISTEN TIPO DE NEGOCIOS EN LA BASE DE DATOS.</h5>
				</td>
			</tr>
			<?php
			}else{
				...
				<td style="text-align: center; font-size: 15px;">
				   <!--<i class="mdi mdi-table-edit" onclick="aparecermodulos('catalogos/empresas/fa_empresas.php?idempresas=<?php echo $resultado_empresas_row['idempresas'];?>','main')" style="cursor: pointer" title="Modificar Empresas"></i>-->
					...
					<?php
						...
						$bt->funcion = "aparecermodulos('catalogos/tiponegocios/fa_tiponegocios.php?idtiponegocio=".$resultado_empresas_row['idtiponegocio']."&idmenumodulo=$idmenumodulo','main')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
					...
					<?php
						...
						$bt->funcion = "BorrarTiponegocio('".$resultado_empresas_row['idtiponegocio']."','idtiponegocio','tiponegocios','n','catalogos/tiponegocios/vi_tiponegocios.php','main','$idmenumodulo')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
						$bt->tipo = 3;
						$bt->title="BORAR";
					...
					<!-- <button class="btn btn-primary" type="button" onclick="Subirimagencategoria(<?php echo $resultado_empresas_row['idtiponegocio']; ?>)" title="SUBIR IMAGENES">
						<i class="mdi mdi-arrow-up-bold-circle"></i>
					</button> -->

<!-- 
					<button class="btn btn_accion" type="button" onclick="PaquetesRelacion(<?php echo $resultado_empresas_row['idtiponegocio']; ?>,'<?php echo $resultado_empresas_row['categoria']; ?>')" title="">
...
<script type="text/javascript">
	 $('#tbl_presentaciones').DataTable( {		
			...
			"oLanguage": {
						...
						"sZeroRecords": "NO EXISTEN TIPO DE NEGOCIOS EN LA BASE DE DATOS.",
