  ...
  <div class="card-body">
    ...
    <div style="float:right;">
      ...
      <?php
        ...
        $bt->funcion = "aparecermodulos('catalogos/tiponegocios/fa_tiponegocios.php?idmenumodulo=$idmenumodulo','main');";
        $bt->estilos = "float: right; margin-right:10px;";
        $bt->permiso = $permisos;
        $bt->tipo = 5;
        $bt->title="NUEVO TIPO DE NEGOCIOS";
        ...
        <tbody>
          <tr> 
            <td colspan="7" style="text-align: center">
                <h4 class="alert_warning">NO EXISTEN TIPOS DE NEGOCIOS EN LA BASE DE DATOS.</h4>
              </td>
            </tr>
        </tbody>
      </table>
...
<script type="text/javascript">
  Buscar_Tiponegocios(<?php echo $idmenumodulo; ?>);
</script>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="hidden" id="idTiponegociosproducto" value="">
