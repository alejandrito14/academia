...
$Zonas->tipo_usuario = $tipousaurio;
$Zonas->lista_empresas = $lista_empresas;

$l_Zonas = $Zonas->ObtenerTodosZonas();
$l_Zonas_row = $db->fetch_assoc($l_Zonas);


$l_Zonas_num = $db->num_rows($l_Zonas);
	...
	<div class="card-body">
		...
		<div style="float:right;">
			...
			<?php
				...
				$bt->funcion = "aparecermodulos('catalogos/zonas/fa_zonas.php?idmenumodulo=$idmenumodulo','main');";
				$bt->estilos = "float: right; margin-right:10px;";
				$bt->permiso = $permisos;
				$bt->tipo = 5;
				$bt->title="NUEVA ESPACIO";
...
<div class="card">
	<div class="card-body">
		<div class="table-responsive" id="contenedor_Zonas">
			<table id="tbl_Zonas" cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
				<thead>
					<tr>
					...
					if($l_Zonas_num== 0){
						...
						do
						{
							...
							<td style="text-align: center; font-size: 15px;">
									...
									$bt->funcion = "aparecermodulos('catalogos/zonas/fa_zonas.php?idmenumodulo=$idmenumodulo&idzona=".$l_Zonas_row['idzona']."','main')";
									$bt->estilos = "";
									$bt->permiso = $permisos;
									$bt->tipo = 2;
									$bt->title="EDITAR";
							...
							<?php
						}while($l_Zonas_row = $db->fetch_assoc($l_Zonas));
					}
					?>
				</tbody>
			</table>
