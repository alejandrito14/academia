...
<div class="card">
	<div class="card-body">
		<h5 class="card-title" style="float: left;">ASIGNAR USUARIO A MEMBRESIAS</h5>
		...
		<div id="botones" style="float: right;position:fixed!important;z-index:10;right:0;margin-right:2em;width: 17%;display: none;">
			...
			<button class="btn btn-primary" onclick="CancelarAsignacion()" style="margin-right: 10px;"><i class="mdi mdi-content-cancel"></i>CANCELAR</button>
				...
				<button class="btn btn-success btnguardar" onclick="GuardarAsignacionMembresia()" ><i class="mdi mdi-content-save"></i>GUARDAR</button>
  ...
  <form class="form-inline">
    ...
    <button class="btn  my-2 my-sm-0" type="button" onclick="ObtenerClientesMembresia()"><span class="mdi mdi-magnify"></span></button>
  </form>
	...
	<form id="f_l_notarias" name="f_l_notarias" style="margin-top: 1em;">
			...
			<div class="col-md-12">
				<div class="subject-info-box-1">
					<label>MEMBRESÍAS POR ASIGNAR</label>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
         <label for="">DESCRIPCIÓN DE MEMBRESÍAS ASIGNADAS</label>
       </div>
      </div>
      <div class="row">
         
        <div class="col-md-6">
           <div class="list-group" id="membresiasdescripcion">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	 ...
      	 <button type="button" class="btn btn-success" onclick="AceptarSeleccionMembresia()">Aceptar</button>
...
<script>
        ...
        $('#btnLeft').click(function (e) {
           ...
           var idMembresia=opts.val();   

           var promesa=VerificarMembresia(idMembresia);
            promesa.then(r => {
                console.log(r);
              if (r.respuesta==0) {
