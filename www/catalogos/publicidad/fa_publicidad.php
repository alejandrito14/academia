...
<form id="f_PUBLICIDAD" name="f_PUBLICIDAD" method="post" action="">
    ...
    z-index: 10;           
     ...
     margin-right: 2em;width: 74%;">
				...
				<button type="button" onClick="aparecermodulos('catalogos/publicidad/vi_publicidad.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i>VER LISTADO </button>
