...
if(!isset($_GET['idtipodepago'])){
	...
	$habilitarsinrevision=0;
$habilitarcatalogobanco=0;
$habilitarcampodigitos=0;
$habilitaropcionestarjeta=0;
...
$chkopcionestarjeta="";
	...
	$habilitarsinrevision=$result_tipodepagos_row['habilitarsinrevision'];
$habilitarcatalogobanco=$result_tipodepagos_row['habilitarcatalogobanco'];
$habilitarcampodigitos=$result_tipodepagos_row['habilitarcampodigitos'];
$habilitaropcionestarjeta=$result_tipodepagos_row['habilitaropciontarjeta'];
 ...
 $chkopcionestarjeta="";
	...
	$che8="";
	if ($habilitarsinrevision==1) {
		$che8="checked";
	}

	if ($habilitarcatalogobanco==1) {
		$chkcatalogobanco="checked";
	}

	if ($habilitarcampodigitos==1) {
			$chkdigitos="checked";
	}

	if ($habilitaropcionestarjeta==1) {
		$chkopcionestarjeta="checked";
	}
					...
					<div class="tab-content tabcontent-border">
						<div class="tab-pane active show" id="generales" role="tabpanel">
							...
							<div class="form-group">
								...
								<input type="checkbox" class="" id="constripe" name="constripe" onchange="habilitarstripe()" value="<?php echo $constripe; ?>" title="HABILITAR STRIPE" placeholder='HABILITAR STRIPE' <?php echo $che2?>>		<label>HABILITAR STRIPE:</label>
							</div>


							<div class="form-group">
						
								<input type="checkbox" class="" id="habilitarcampomonto" name="habilitarcampomonto" onchange="habilitarmonto()" value="<?php echo $habilitarcampo; ?>" title="HABILITAR CAMPO" placeholder='HABILITAR CAMPO' <?php echo $che3?>>		<label>HABILITAR CAMPO ¿Con cuanto pagas? :</label>
							</div>
							...
							<div class="form-group publica" style="display: <?php echo $visualizar;?>;">
								...
								<input type="checkbox" class="" id="chkparafactura" name="chkparafactura"  title="" onchange="Habilitarparafactura()" value="<?php echo $chkparafactura; ?>"placeholder='' <?php echo $che5 ?>>		<label>HABILITAR TIPO DE PAGO PARA FACTURA:</label>
							</div>

								<div class="form-group">
				
								<input type="checkbox" class="" id="chkpararevision" name="chkpararevision"   onchange="Habilitarpararevision()" value="<?php echo $habilitarsinrevision; ?>"placeholder='' <?php echo $che8 ?>>				<label>HABILITAR SIN REVISIÓN:</label>
							</div>


								<div class="form-group">
							
								<input type="checkbox" class="" id="chkcatalogobanco" name="chkcatalogobanco"   onchange="Habilitarcatalogobancos()" value="<?php echo $habilitarcatalogobanco; ?>"placeholder='' <?php echo $chkcatalogobanco;?>>	<label>HABILITAR CATÁLOGO DE BANCOS:</label>
							</div>

								<div class="form-group">
						
								<input type="checkbox" class="" id="chkdigitos" name="chkdigitos"   onchange="Habilitardigitos()" value="<?php echo $habilitarcampodigitos; ?>"placeholder='' <?php echo $chkdigitos ?>>
										<label>HABILITAR DÍGITOS:</label>
							</div>
								...
								<input type="checkbox" class="" id="chkopcionestarjeta" name="chkopcionestarjeta"   onchange="Habilitaropcionestarjeta()" value="<?php echo $habilitaropcionestarjeta; ?>"placeholder='' <?php echo $chkopcionestarjeta ?>>
										<label>HABILITAR OPCIONES DE TARJETA(DÉBITO/CRÉDITO):</label>
							</div>
