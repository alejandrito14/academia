...
try
{
	...
	$tipodepagos->habilitarsinrevision=$_POST['chkpararevision']!=''?$_POST['chkpararevision']:0;

	$tipodepagos->habilitarcatalogobanco=$_POST['chkcatalogobanco'];
	$tipodepagos->habilitarcampodigitos=$_POST['chkdigitos'];
	$tipodepagos->habilitaropciontarjeta=$_POST['chkopcionestarjeta'];
