...
<div class="card">
	<div class="card-body">
		<h5 class="card-title" style="float: left;">ASIGNAR USUARIOS A DESCUENTOS</h5>
		...
		<div id="botones" style="float: right;position:fixed!important;z-index:10;right:0;margin-right:2em;width: 17%;display: none;">
			...
			<button class="btn btn-primary" onclick="CancelarAsignacion()" style="margin-right: 10px;"><i class="mdi mdi-content-cancel"></i>CANCELAR</button>
				...
				<button class="btn btn-success btnguardar" onclick="GuardarAsignacionDescuento()" ><i class="mdi mdi-content-save"></i>GUARDAR</button>
  ...
  <form class="form-inline">
    ...
    <button class="btn  my-2 my-sm-0" type="button" onclick="ObtenerClientesDescuento()"><span class="mdi mdi-magnify"></span></button>
  </form>
 ...
 <div id="listarseleccionados">
	...
	<form id="f_l_notarias" name="f_l_notarias" style="margin-top: 1em;">
			...
			<div class="col-md-12">
				<div class="subject-info-box-1">
					<label>DESCUENTOS POR ASIGNAR</label>
				...
				<div class="subject-info-box-2">
					<label>DESCUENTOS ASIGNADOS</label>
  ...
  <div class="card carddescripcion" style="display: none;">
    <div class="card-title"></div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-12">
         <label for="">DESCRIPCIÓN DE DESCUENTOS ASIGNADOS</label>
       </div>
      </div>
      <div class="row">
         
        <div class="col-md-6">
           <div class="list-group" id="descuentosdescripcion">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	 ...
      	 <button type="button" class="btn btn-success" onclick="AceptarSeleccionDescuento()">Aceptar</button>
...
<script>
        ...
        $('#btnLeft').click(function (e) {
           ...
           var iddescuento=opts.val();   

           var promesa=VerificarDescuento(iddescuento);
            promesa.then(r => {
                console.log(r);
              if (r.respuesta==0) {
