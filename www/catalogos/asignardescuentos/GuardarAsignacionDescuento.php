...
try
{
	...
	$md->guardarMovimiento($f->guardar_cadena_utf8('Descuento'),'Asignación a usuario descuento',$f->guardar_cadena_utf8('Asignación a usuario -'.$ids.' descuentos: '.$iddescuentos));
