...
<div class="card">
	<div class="card-body">
		<h5 class="card-title" style="float: left;">CONFIGURACIÓN DE EMPRESA</h5>
		...
		<div style="float:right;">
			...
			if($tipousaurio == 0)
			{
				...
				$bt->funcion = "aparecermodulos('catalogos/empresa/fa_empresas.php?idmenumodulo=$idmenumodulo','main');";
