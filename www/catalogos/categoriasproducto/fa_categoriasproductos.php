...
if(!isset($_GET['idcategoria'])){
	...
	$col = "col-md-12";
	$ver = "display:none;";
	$titulo='NUEVA FAMILIA DE PRODUCTO';
	...
	$col = "col-md-12";
	$ver = "";
		$titulo='EDITAR FAMILIA DE PRODUCTO';
						...
						<div class="form-group m-t-20">
							...
							<select name="v_estatus" id="v_estatus" title="Estatus" class="form-control"  >
								...
								<option value="1" <?php if($estatus == 1) { echo "selected"; } ?> >ACTIVADO</option>
												...
												<div class="form-group m-t-20">
													<button type="button" class="btn btn-primary" onclick="NuevaCategoria()">AGREGAR SUBCATEGORÍA</button>
												</div>
								    ...
								    <div class="card" style="width: 18rem;margin: auto;margin-top: 3em;">
								        ...
								        <div class="card-body">
								            ...
								            <div class="form-group">
								                ...
								                <input type="file" class="form-control-file" name="image" id="image" onchange="SubirImagenCategoriaSub()">
								            </div>
								          <!--   <input type="button" class="btn btn-primary upload" value="Subir"> -->
								        </div>
								    </div>
...
<p style="text-align: center;">Dimensiones de la imagen Ancho:640px Alto:426px</p>
							...
							<div class="form-group m-t-20">
								<label>*NOMBRE:</label>
							<input type="text" class="form-control" id="v_nombresub" name="v_nombresub" value="<?php echo $nombre; ?>" title="NOMBRE" placeholder='NOMBRE'>
							</div>
							...
							<div class="form-group m-t-20" style="display: none;" >
								...
								?>
								<select  class="form-control" id="v_dependesub" name="v_depende" >
									<option value="0" <?php if(0==$depende){ echo ("selected");}?>>NINGUNO</option>
									<?php
									do{
									?>
							...
							<div class="form-group m-t-20">
								<label>*ORDEN:</label>
							<input type="number" class="form-control" id="v_ordensub" name="v_orden" value="<?php echo $orden; ?>" title="orden" placeholder='ORDEN'>
							</div>
						...
						<div class="form-group m-t-20">
							<label>ESTATUS:</label>
							<select name="v_estatus" id="v_estatussub" title="Estatus" class="form-control"  >
