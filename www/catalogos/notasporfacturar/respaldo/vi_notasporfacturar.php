...
$l_pagos = $notapago->ObtTodosNotaPagosparaFacturar();
...
<div class="card">
	<div class="card-body">
		<h5 class="card-title" style="float: left;">LISTADO DE NOTA DE PAGOS POR FACTURAR</h5>
		...
		<div class="table-responsive" id="contenedor_Pagos">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="notasporfacturar" style="height: 400px;
					...
					<div>
						<ul class="list-group divmonedero" style="display: none;">
							...
							<div class="row" style="margin-top: 1em;">
								...
								<div class="row">
								<div class="col-md-12 datosfacturacion">
							...
							<div class="row">
								<div class="col-md-12">
									<button class="btn btn-success btncambiarestatus" onclick="">AÑADIR FOLIO</button>
								</div>
							</div>
...
<div class="modal" id="modalfoliofactura" tabindex="-1" role="dialog">
