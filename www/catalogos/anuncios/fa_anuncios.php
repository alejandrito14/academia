	...
	<div class="card">
		<div class="card-body">
			...
			<div style="float: right;position:fixed!important;z-index:10;right:0;margin-right:2em;width: 20%;">
				...
				<button type="button" onClick="aparecermodulos('catalogos/anuncios/vi_anuncios.php?idmenumodulo=<?php echo $idmenumodulo;?>','main');" class="btn btn-primary" style="float: right; margin-right: 10px;"><i class="mdi mdi-arrow-left-box"></i>VER LISTADO</button>
					...
					<div class="tab-content tabcontent-border">
						<div class="tab-pane active show" id="generales" role="tabpanel">
							...
							<div class="col-md-6" >
									...
									<p style="text-align: center;">Dimensiones de la imagen 
									Ancho:979px Alto:1916px</p>
								</div>
