...
$cli->lista_empresas = $lista_empresas;
	 ...
	 $sql_cliente = $cli->lista_Usuarios('5');
...
<div class="card mb-3">
	<div class="card-header">
		...
		$bt->titulo = "NUEVO COACH";
		$bt->icon = "mdi-plus-circle";
		$bt->funcion = "
	
			 aparecermodulos('catalogos/coachs/fa_coach.php?idmenumodulo=$idmenumodulo','main');
			 ";
		$bt->estilos = "float: right; margin-right: 10px;";
		$bt->permiso = $permisos;
		$bt->tipo = 5;
		$bt->title="NUEVO COACH";
		$bt->armar_boton();
					  	  ...
					  	  <!--	<td style="text-align:center;"><?php echo utf8_encode($result_sucursal_row['sucursal']); ?></td>-->
						  	<td align="center">
										...
										<?php
													...
													$bt->funcion = "aparecermodulos('catalogos/coachs/fa_coach.php?idmenumodulo=$idmenumodulo&idusuarios=".$result_row['idusuarios']."','main')";
													$bt->estilos = "";
													$bt->permiso = $permisos;
													$bt->tipo = 2;
													$bt->title="EDITAR";
													...
													$bt->funcion = "BorrarCliente('".$result_row['idusuarios']."','".$nombre."',".$idmenumodulo.",'catalogos/coachs/vi_coachs.php')";
													$bt->estilos = "";
													$bt->permiso = $permisos;
													$bt->tipo = 3;
													$bt->title="BORRAR";
