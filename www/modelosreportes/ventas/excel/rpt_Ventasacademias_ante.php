...
//Recibo parametros del filtro
	...
	$subidcategoria=$_GET['v_subsubcategorias'];
...
if ($idcoach!='') {
	...
	$sql="
			 SELECT idcategoriasservicio, nombrecategoria from categoriasservicio WHERE 1=1 ";

	if ($subidcategoria!='') {

		$sql.=" AND idcategoriasservicio IN($subidcategoria)";
	}
 		...
 		<table class="table  table table-striped table-bordered table-responsive vertabla" border="1" style="">
		  ...
		  <tbody>
   		 ...
   		 $datoscoach=$usuarios->ObtenerUsuarioDatos();
						...
						$obtenerservicios=$asignacion->obtenerServiciosAsignadosCoach5($sqlcate,$sqlfechasservicio,$idcategoriasservicio);
					 $pagosdelcoach=array();
				  	...
				  	$fechafinal=$obtenerpago[0]->fechafinal;
			 			...
			 			$nombredescuento=$descuento[0]->nombredescuento;
			 				...
			 				$montoadescontarpago=$descuento[0]->montodescontar;
			 					...
			 					$array[$k]->montocobrado=$montopago+$array[$k]->montocobrado;
			 		}
	...
	//var_dump($array);die();
				     ...
				     <?php //$alumno=$pagosdelcoach[$l]['corresponde'][0]->nombre.' '.$pagosdelcoach[$l]['corresponde'][0]->paterno.' '.$pagosdelcoach[$l]['corresponde'][0]->materno;
				      ...
				      ?>
 								...
 								<td><?php echo $array[$l]->nodeservicios ?></td>
				     

				     <td>$<?php echo number_format($array[$l]->montoporcobrar,2,'.',','); ?></td>
				     

				      <td>$<?php echo number_format($array[$l]->montocobrado,2,'.',','); ?></td>
